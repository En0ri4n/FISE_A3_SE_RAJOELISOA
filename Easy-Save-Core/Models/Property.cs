...
public class Property<T>(string name, T value, string? description = null)
{
    ...
    public override bool Equals(object? obj)
    {
        ...
        return _name == other._name && _description == other._description && EqualityComparer<T>.Default.Equals(_value, other._value);
    }
